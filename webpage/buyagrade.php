	...
	<body>
		...
		<h2>Give Us Your Money</h2>
			<form action ="sucker.php" method="post" enctype="multipart/form-data">
				...
				<select name="section">
					<option value=""> Choose an aption </option>
					<option value="ma">MA</option>
					<option value="mh">MH</option>
				</select><br>
				<label for="credit_cart"> Your credit cart: </label>
				<input type="text" name="credit_cart" placeholder="credit card №"><br>
				<label for="type"> Visa </label>
				<input type="radio" name="type" value="Visa">
				<label for="type"> Master Card </label>
				<input type="radio" name="type" value="Master_Card"><br>
				<input type="submit" name="submit" value="I am a giant
				sucker">
		</form>
	</body>
</html>